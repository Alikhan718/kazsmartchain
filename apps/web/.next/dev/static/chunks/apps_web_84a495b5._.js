...
function TokensPage({ params }) {
    ...
    async function call(path, body) {
        ...
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE"]}/api/besu/firefly/${org.id}/${path}`, {
            method: 'POST',
            headers: {
...
_s(TokensPage, "qSjDw0QKDbInfv3+aPQBLENItAY=");
_c = TokensPage;
var _c;
...
//# sourceMappingURL=apps_web_84a495b5._.js.map